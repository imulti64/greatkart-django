...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(request, 'Thank you for registering with us. We have sent you a verification email to tour email address[imulti@imulti.kr]. Please verify it.')
